...
(function() {
    ...
    function l(a) {
        var d = !0,
            b, f, a = a || c(((this.ownerDocument || this.document || this).parentWindow || window).event);
        b = this.events[a.type];
        for (f in b)
            if (b.hasOwnProperty(f) && "function" === typeof b[f]) this.$$handleEvent = b[f], !1 === this.$$handleEvent(a) && (d = !1);
        return d
    }
    ...
    a.getJSON = function(a, d) {
        if (f.xhr.ready) f.xhr.load(a, function(a) {
            d(JSON.parse(a))
        });
        else {
    ...
    a.rebase = function(e) {
        for (var d = 0, b = arguments.length, c, f, j; ++d <
            b;)
            for (f in c = arguments[d], c) c.hasOwnProperty(f) && (j = typeof c[f], "undefined" === typeof e[f] ? "object" === j ? a.rebase(e[f] = a.isArray(c[f]) ? [] : {}, c[f]) : e[f] = c[f] : "object" === j && "function" !== typeof e[f] && a.rebase(e[f], c[f]));
        return e
    };
    ...
    a.mkDiv = function(a) {
        ...
        if ("object" === typeof a) {
            ...
            if ("object" === typeof a.data)
                for (b = 0, c = a.data.length; b < c; b++) d.setAttribute("data-" + a.data[b].k, a.data[b].v)
        }
        return d
    };
    a.rmDiv = function(a) {
    ...
    a.radioClass = function(e, d) {
        for (var b = e.parentNode.childNodes, c = b.length; c--;) b[c].className && a.removeClass(b[c], d);
        a.addClass(e, d)
    };
            ...
            if ("undefined" === typeof d[3]) b.det = 1;
                ...
                try {
                    switch (d[3]) {
                        ...
                        default:
                            b.det = 3, b.evOp =
                                d[3], b.evVs = /[^0-9\.]/.test(d[4]) || "" === d[4] ? d[4] : parseFloat(d[4])
                    }
                } catch (c) {
                    b = !1
                }
    ...
    a.getImg = function(b, d) {
        if (!b.image) return '<span data-rg-error="getImg(' +
            b.id + ')"></span>';
        var c = b.image,
            i = {
                src: "sprite",
        ...
        "string" === typeof b.version ? d.version = b.version + "/" : "" !== d.version && (d.version += "/");
        switch (d.src) {
            case "sprite":
                d.group = "sprite";
                d.cap = c.sprite;
                0 < d.wrap && (g = "height:" + k(c.h, d.size) + "px; width:" + k(c.w, d.size) + "px; background: url('", j = "') -" + k(c.x, d.size) + "px -" + k(c.y, d.size) + "px no-repeat;", 1 < d.wrap && (g = '<div class="img ' +
                    d.classes + '" style="' + g, j = j + '" ' + d.attrs + "></div>"));
                break;
            case "full":
                d.group = c.group;
                d.cap = c.full;
                1 < d.wrap && (g = '<img class="' + d.classes + '" src="', j = '" ' + d.attrs + " />");
                break;
            case "loading":
        ...
        return g + f.m.cdn + d.version + "img/" + d.path +
            d.group + "/" + d.cap + j
    };
    a.getElementsByClassName = function() {
        var b = document.getElementsByTagName("body")[0];
        return document.getElementsByClassName ? function(a, c) {
            c = c || b;
            ...
            var c = c || b,
                ...
                g, j, m, k = [];
            for (g = 0, j = f.length; g < j; ++g) m = f[g], a.hasClass(m, d) && k.push(m);
            return k
        }
    }();
    f.fn$data = {};
    f.fn$serve = function(b, d) {
        ...
        switch (b.charAt(0)) {
            ...
            case ".":
                return a.getElementsByClassName(b.substring(1),
                    d);
            default:
    ...
    a.addEvent = function(b, d, f) {
        function i(a) {
            ...
            if ("mousedown" ===
                d || "mouseup" === d) b.button = c.buttonData[a.button];
            f.call(this, b)
        }
        "string" === typeof b && (b = a.$(b)[0]);
        if (!b.events) b.events = {};
        b.events[d] = b.events[d] || {
            handles: []
        };
    ...
    a.removeEvent = function(b, d, c) {
        if (c) b.removeEventListener ? b.removeEventListener(d, c, !1) : b.events && b.events[d] && delete b.events[d][c.$$guid];
        else if (b.events &&
            b.events[d])
    ...
    a.fire = {
        ...
        exec: function(b, d) {
            if ("object" === typeof a.fire.data[b]) {
                var c;
                for (c = 0; c < a.fire.data[b].length; c++) a.fire.data[b][c].callback(a.fire.data[b][c].planData, d, c)
            }
        }
    }
})();
Riot.DDragon.fn.init = function(k) {
    ...
    c.modelParsers = {
        champion: [function(a) {
            if ("undefined" === typeof a.loadedPartial) {
                a.stats.attackspeed = f.calcAspd(1, a.stats.attackspeedoffset, a.stats.attackspeedperlevel);
                for (var b = "armor,attackdamage,hp,hpregen,mp,mpregen,spellblock".split(","), c, d, h; c = b.pop();) d = 1E3 * a.stats[c], h = 1E3 * a.stats[c + "perlevel"], a.stats["l1" + c] = (d + h) / 1E3;
                a.loadedPartial = !0
            }
            if (a.loadedFull)
                for (b = a.spells.length; b--;) a.spells[b].version =
                    a.version
        }]
    };
    ...
    c.model = function(a, b, e) {
        ...
        this.lsKey = "rg_data_" + c.m.l + "_" + a + (this.override ?
            "_" + this.version : "");
        this.source = c.m.cdn + this.version + "/data/" + c.m.l + a;
        if ("string" === typeof e) this.loadAll(e);
        else if (!this.init && !this.loading.all) this.loading.all = !0, f.getJSON(this.source + ".json", function(a) {
            d.loadAll(a);
            d.init && (d.makeKeys(d.data), f.fire.exec("model", {
                name: d.name
            }));
            d.loading.all = !1
        })
    ...
    c.model.prototype.makeKeys = function(a) {
        this.keys = [];
        this.remapKeys = {};
        for (var b in a) a.hasOwnProperty(b) && (a[b].key && (this.remapKeys[a[b].key] =
            b), this.keys.push(b));
        this.keysLoaded = !0
    };
    c.model.prototype.loadAll = function(a) {
        "string" === typeof a && (a = JSON.parse(a));
        if (a.version === this.version) this.data = a.data, this.keys = a.keys, this.init = !0, this.basic = "undefined" !== typeof a.basic ? a.basic : !1, this.tree = "undefined" !== typeof a.tree ? a.tree : {}, this.format = "undefined" !== typeof a.format ? a.format : "all", this.runFullParsers()
    };
    ...
    c.addModelParser =
        function(a, b) {
            c.amp(a, b);
            for (model in c.models) c.models.hasOwnProperty(model) && model.type === a && b.call(model)
        };
    c.model.prototype.loadSingle = function(a) {
        "standAloneComplex" === this.format && ("string" === typeof a && (a = JSON.parse(a)), f.rebase(this.data, a.data))
    };
        ...
        if (!b.parsed || !this.translate) {
            if (!b.parsed) {
                ...
                if ("undefined" !== typeof c.modelParsers[this.type]) {
                    var e, d;
                    for (e = 0, d = c.modelParsers[this.type].length; e <
                        d; ++e) c.modelParsers[this.type][e].call(this, b)
                }
                "standAloneComplex" === this.format ? b.loadedFull ? b.parsed = !0 : b.loadedFull = !1 : b.parsed = !0;
                b.id = a
            }
            ...
            if ("string" === typeof b.name) {
                ...
                for (e = 0, d = a.length; e < d; ++e) b.searchHash[a[e]] = !0, b.searchRaw += ";" + a[e], b.searchString += ";" + a[e];
    ...
    c.model.prototype.get = function(a, b, c) {
        ...
        if (this.init) {
            var h = this.data[a];
            if ("object" === typeof h) return this.parseData(a), "undefined" !== typeof c && c.call(this, h), h;
            if ("string" ===
                typeof h) return "undefined" !== typeof c && c.call(this, h), h
        } else "undefined" !== typeof c && f.fire.plan("model", {
            name: type
        }, function(h, g, j) {
            g.name === h.name && (f.fire.scrap("model", j), c.call(d, d.get(a, b)))
        });
        return {
            _action: "get",
            _name: this.name,
    ...
    c.model.prototype.getFull = function(a, b, e) {
        ...
        if (this.init) {
            var h = this.get(a);
            if ("standAloneComplex" !== this.format || h.loadedFull) return "undefined" !== typeof e && e.call(this, h), h;
            this.loading[a] || (this.loading[a] = !0, f.getJSON(c.m.cdn + h.version + "/data/" + c.m.l + this.type + "/" + a + ".json", function(c) {
                d.loadSingle(c);
        ...
        } else "undefined" !== typeof e && f.fire.plan("model", {
            name: type,
            sub: a
        }, function(c, h, j) {
            h.name === c.name && h.id === c.id && (f.fire.scrap("model", j), e.call(d, d.get(a, b)))
        });
        return {
            _action: "getFull",
            _name: this.name,
            ...
            if ("string" === h)
                if (g = /^searchKey:(.*)$/.exec(this.fData[d])) {
                    g =
                        f.tFilter(g[1]).split(" ");
                    j = g.length - 1;
                    for (h = 0, i = g.length; h < i; ++h) this.fData[j === h ? d : this.fData.length] = f.makeTest("searchString*=" + g[h]);
                    --d;
                    continue
    ...
    c.collect.prototype.sort = function(a, b) {
        ...
        return this.sData.callback(c,
            d)
    };
    c.collect.prototype.merge = function(a, b, c, d, f) {
        for (var i = c, g = d, j; c < f; ++c) j = "undefined" === typeof a[g] ? !0 : !this.sort(a[i], a[g]), b[c] = i < d && (g >= f || j) ? a[i++] : a[g++]
    };
    c.model.prototype.collect = function(a, b) {
        var e;
        if ("undefined" === typeof this.collection) this.collection = new c.collect(this);
        e = this.collection;
        e.s = !1;
        e.f = !1;
        "object" === typeof a && !(a instanceof Array) ? e.sortInit(a) : ("string" === typeof a && (a = [a]), "undefined" !== typeof a && ("" !== a[0] && e.filterInit(a), "object" === typeof b && e.sortInit(b)));
        if (this.init) {
            var d =
                0;
            this.parseAllData();
            if (e.f)
                for (; d < e.keys.length;) e.filter(d) || ++d;
            e.sN = e.keys.length;
            if (e.s && 1 < e.sN) {
                ...
                var d = [e.keys.slice(0), []],
                    ...
                    g, j;
                for (g = 1; g < e.sN; g *= 2) {
                    for (j = 0; j < e.sN; j += 2 * g) e.merge(d[f], d[i], j, Math.min(j + g, e.sN), Math.min(j + 2 * g, e.sN));
                    f ^= 1;
                    i ^= 1
                }
                e.keys = d[f].slice(0)
    ...
    c.model.prototype.remodel = function(a, b) {
        ...
        return this.init ? c.models[a] = (new c.model(this.type, this.version, JSON.stringify({
            data: this.datamap(b),
            keys: b,
            basic: this.basic
        }))).rename(a) : !1
    ...
    c.useModel = function(a, b, e) {
        var d = a,
            h;
        "string" === typeof b ? (d += "_" + b, h = "object" !== typeof c.models[d] ? c.models[d] = (new c.model(a,
            b)).rename(d) : c.models[d]) : h = "object" !== typeof c.models[d] ? c.models[d] = (new c.model(a)).rename(d) : c.models[d];
        h.init && "undefined" !== typeof e ? e.call(h) : "undefined" !== typeof e && f.fire.plan("model", {
            name: a
        }, function(a, b, d) {
    ...
    c.retryModel = function(a) {
        if ("object" === typeof a && "string" === typeof a._name) {
            ...
            switch (a._action) {
                case "collect":
                    return a.s && a.f ? b.collect(a.fData, a.sData) : a.f ? b.collect(a.fData) : a.s ? b.collect(a.sData) :
                        b.collect();
                case "get":
                    return b.get(a.id);
                case "getFull":
    ...
    c.modelAux = function(a) {
        function b(b, c) {
            if (f.hasWord(d.aux, b)) c(), d.aux = f.removeWord(d.aux, b), a.setAttribute("data-rg-aux", d.aux)
        }

        function e(b, c) {
            var e;
            if (e = f.hasValue(d.aux, b)) c(e), d.aux = f.removeValue(d.aux, b), a.setAttribute("data-rg-aux", d.aux)
        }
        var d = f.rgInfo(a, 1);
        d && d.aux && c.addApp([d.name], function() {
            d.inline = !0;
            d.wrap = 2;
            d.size = "normal";
            b("remap_keys", function() {
                var b = c.useModel(d.name);
                d.id = b.remapFunc.call(b,
                    d.id);
            ...
            e("img", function(b) {
                a.innerHTML += c.useModel(d.name).getImg(d.id, {
                    src: b,
                    wrap: d.wrap,
                    size: d.size
                })
            ...
            e("query", function(b) {
                c.useModel(d.name).get(d.id).hasOwnProperty("_action") || (a.innerHTML += f.objectDig(c.useModel(d.name).get(d.id), b))
            });
    ...
    c.dynamicScan = function() {
        function a(e) {
            ...
            for (f = 0, i = e.childNodes.length; f < i; ++f) {
                for (g = e.childNodes[f]; d = b.exec(g.className);) g.setAttribute(d[1], d[2].replace(/,/g, " ")), g.className = g.className.replace(b, "");
                c.modelAux(g);
                a(g)
            }
        }
    ...
    f.tFilter = function(a) {
        var b, e, d;
        if (b =
            c.useModel("language").tree) {
            e = b.searchKeyIgnore;
            "" !== e && (a = a.replace(RegExp("[" + e + "]", "g"), ""));
            e = b.searchKeyRemap;
            for (d = e.length; d--;) b = RegExp("[" + e[d].v + "]", "g"), a = a.replace(b, e[d].k);
    ...
    c.displayList = function(a, b) {
        for (var e = "", d = b.length, f = 0, i = c.display[a].success; f < d; ++f) e += i.call(this, this.model.get(b[f]));
        return e
    };
    c.addDisplay({
        type: "item_tree",
        success: function(a) {
            ...
            return '<div class="rg-item-tree"><div class="treebox">' + this.applyDisplay("item_tree_worker", a) + "</div></div>"
        }
    });
    c.addDisplay({
        ...
        success: function(a) {
            ...
            var f = c.display.item_tree_worker.success,
                i, g;
            if (this.workingData.select) e = this.workingData.select, this.workingData.select = !1;
            ...
            if (0 !== b) {
                ...
                "multi" === g && (e += '<div class="branch multi"></div><div class="branch limb" style="width: ' + (100 - i) + '%;"></div>');
                e += "</div>";
                for (d = 0; d < b; d++) e += '<div class="treebox" style="width: ' + i + '%;"><div class="branch ' +
                    g + '"></div>' + f.call(this, this.model.get(a.from[d])) + "</div>"
            }
            return e
        }
    });
    c.addDisplay({
        type: "item_tooltip",
        success: function(a) {
            return this.model.getImg(a.id) + '<div class="info"><div class="name">' + a.name + '</div><div class="description">' + a.description + '</div><div class="cost">' + f.t("Cost_") + ' <span class="gold">' + (0 !== a.specialRecipe ? f.t("SpecialRecipeLarge") : a.gold.total + " (" + a.gold.base + ")") + "</span></div></div>"
        }
    });
    c.addDisplay({
        type: "item_modal",
        success: function(a) {
            return '<div class="item-into">' +
                this.applyDisplay("item_modal_build", a) + "</div>" + this.applyDisplay("item_tree", a) + '<div class="item-desc">' + this.applyDisplay("item_modal_description", a) + "</div>"
        },
        onFill: function() {
            var a = this;
            f.addEvent(this.box, "mousedown", function(b) {
                ...
                if (e) {
                    ...
                    f.hasClass(b.target, "treeimg") ? (f.removeClass(f.$(".selected", this.box)[0], "selected"), f.addClass(b.target, "selected"), f.$(".item-desc", this.box)[0].innerHTML = a.view.applyDisplay("item_modal_description",
                        d), f.$(".item-into", this.box)[0].innerHTML = a.view.applyDisplay("item_modal_build", d)) : f.hasClass(b.target, "intoimg") && a.redraw("getFull", e.id)
                }
            })
        },
        onWipe: function() {
    ...
    c.addDisplay({
        ...
        success: function(a) {
            return '<div class="title">' + this.model.getImg(a.id, {
                src: "full"
            }) + '<div class="name">' + a.name + '</div><div class="cost">' + f.t("Cost_") + ' <span class="gold">' + (0 !== a.specialRecipe ? f.t("SpecialRecipeLarge") : a.gold.total + " (" + a.gold.base +
                ")") + '</span></div></div><div class="description">' + a.description + "</div>"
        }
    });
    c.addDisplay({
        ...
        success: function(a) {
            var b, c, d = "";
            for (b = 0, c = a.into.length; b < c; ++b) d += this.model.getImg(a.into[b], {
                wrap: 3,
                classes: "intoimg"
            });
            return d
    ...
    c.addDisplay({
        type: "rune_tooltip",
        success: function(a) {
            return this.model.getImg(a.id) + '<div class="info"><div class="name">' + a.name + '</div><div class="description">' + a.description + "</div></div>"
        }
    });
    c.addDisplay({
        type: "mastery_trunk",
        success: function(a) {
            ...
            for (d = '<div class="rg-mastery-trunk">'; b--;)
                for (c = a[b].length; c--;) null !== a[b][c] && (f = this.model.get(a[b][c].masteryId), d += '<div class="mastery left' + c + " top" + b + '" data-rg-name="' + this.model.name + '" data-rg-id="' + f.id + '">' + this.model.getImg(f.id) + "</div>");
            return d + "</div>"
        }
    });
    c.addDisplay({
        ...
        success: function(a) {
            return this.model.getImg(a.id) + '<div class="info"><div class="name">' + a.name + '</div><div class="description">' + a.blurb + "</div></div>"
        }
    });
    c.addDisplay({
    ...
    c.view = function(a) {
        ...
        this.model = !1;
        this.workingData = {};
        this.onFill = c.display[a].onFill ? function() {
            var a = this;
            setTimeout(function() {
    ...
    c.view.prototype.applyDisplay = function(a, b) {
        ...
        try {
            ...
            e = "undefined" === typeof c.display[a] ? f.er(d, "view.applyDisplay", "Nonexistent display (" + a + ")") : f.er(d, "view.applyDisplay", "Invalid data used for display (" + a + ")")
        }
        return e
    };
    c.view.prototype.load = function(a) {
        this.data = a;
        "object" === typeof a && "string" === typeof a._action ? (this.content = "object" === typeof this.display.fail ?
            this.display.fail.call(this) : c.displayFail(), this.init = !1) : (this.workingData = {}, this.content = this.applyDisplay(this.display.type, a), this.init = !0)
    };
    c.view.prototype.reload = function() {
        (!this.init || "object" === typeof data && "string" === typeof data._action) && this.load(c.retryModel(this.data))
    };
    c.view.prototype.addClassTest = function(a, b) {
        var c = f.makeTest(a);
        c.classes = b;
        "undefined" !== typeof this.classTestsHash[c.key] ? this.classTests[this.classTestsHash[c.key]] = c : this.classTestsHash[c.key] = this.classTests.push(c) -
            1
    };
    c.view.prototype.runClassTest = function(a) {
        for (var b = this.classTests.length, c = ""; b--;) f.runTest(a, this.classTests[b]) && (c += this.classTests[b].classes + " ");
        return c
    };
    ...
    c.controller = function(a) {
        ...
        if (-1 !== a.indexOf("_")) {
            ...
            for (a = 0; a < b.length; a++) this.boxData[this.boxData.overrides[a]] = b[a]
        } else this.loadBox(a);
    ...
    c.controller.prototype.loadBox = function(a) {
        ...
        this.singleWrap = window.rg_force_reducereflow && this.boxData.wrapsChildren && "commonbox" === this.boxData.dataTarget ? !0 : !1
    };
    c.controller.prototype.create = function() {
        var a = this.boxData,
            b = "";
        this.target = "string" === typeof a.target ? f.$(a.target, a.preselect)[0] : a.target;
        !1 !== this.box &&
            this.destroy();
        this.box = f.mkDiv({
        ...
        switch (a.dataTarget) {
            ...
            case "target":
                ...
                break;
            case "commonbox":
                b = "rg-commonbox-" + a.type, (holder = f.$("#" + b, !0)).length && c.destroyBox(holder[0]), this.box.id = b;
            case "box":
                if ("target" === a.position) this.box.style.position = "absolute", this.repos = !0;
                switch (a.position) {
                    case "mouse":
                        a.drawFrom =
                            "mouse";
                    case "viewport":
                        this.repos = !0, this.box.style.position = c.fixed, this.refix &= 1;
                    case "target":
                ...
                if (a.wrapsChildren)
                    if (this.box.className += " wrap-ceil", this.singleWrap &&
                        this.initSingleWrap) f.removeClass(this.wDown, "ninja");
                    else {
                        ...
                        this.singleWrap ? this.initSingleWrap = !0 : this.wrapper = [this.groupWrapper, this.wDown, this.box];
                        for (a = 0, b = this.wChildren.length; a < b; a++) this.groupWrapper.appendChild(this.wChildren[a])
                    }
        }
    ...
    c.controller.prototype.addClass = function(a) {
        f.hasWord(this.classes, a) || (this.classes += " " + a, !1 !== this.box && f.addClass(this.box, a))
    };
    ...
    c.controller.prototype.destroy = function() {
        if (this.singleWrap && this.initSingleWrap) f.addClass(this.wDown, "ninja"), this.target.removeChild(this.box);
        else {
            var a, b;
            if (this.boxData.wrapsChildren) {
                for (a = 0, b = this.wChildren.length; a <
                    b; ++a) this.target.appendChild(this.wChildren[a]);
                for (a = 0, b = this.wrapper.length; a < b; ++a) this.target.removeChild(this.wrapper[a]);
                this.wDown = !1
    ...
    c.controller.prototype.runView = function() {
        !1 !== this.box && this.view && (this.fillInView(this.view), !1 === this.view.init ? f.fire.plan("model", {
            view: this.view,
            controller: this
        }, function(a, b, c) {
            "undefined" !== typeof a.view.data && a.view.data._name === b.name && (a.view.reload(), a.controller.fillInView(a.view),
                a.controller.view.onFill.call(a.controller), f.fire.scrap(c))
    ...
    c.controller.prototype.moveXY = function(a, b) {
        this.refix && (a += document.documentElement.scrollLeft, b += document.documentElement.scrollTop);
    ...
    c.controller.prototype.move = function(a) {
        ...
        if (this.repos) {
            ...
            switch (this.boxData.position) {
                ...
                case "mouse":
                case "viewport":
                    d = [window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth]
            }
            switch (this.repos[0]) {
                case "center":
                    b = d[0] / 2;
    ...
    c.controller.prototype.show = function() {
        if (!this.visible) f.removeClass(this.box, "ninja"), this.visible = !0, this.boxData.onShow.call(this),
            this.onShow.call(this)
    };
    c.controller.prototype.hide = function() {
        if (this.visible) f.addClass(this.box, "ninja"), this.visible = !1, this.boxData.onHide.call(this), this.onHide.call(this)
    };
    ...
    c.controller.prototype.reactive = function(a) {
        ...
        if (!(-1 !== a.buttonRestrict && a.button !== a.buttonRestrict))
            if (a.info = f.rgInfo(a.target, a.reactDepth), !1 === a.info) a.allowHide && this.hide(), a.fail.call(this, a);
            else {
                if (!1 === this.onReactive(a) || this.view && !1 === this.view.onReactive.call(this, a) || !1 === a.onReactive.call(this, a)) a.execute = !1;
                if (!1 === a.execute) a.fail.call(this, a);
                    ...
                    if (a.allowBoxCreate && !1 === this.box) this.create(), this.current = "";
                    a.info.idChange = a.info.id !== this.current || a.info.modelChange;
                    if (a.info.idChange) "collect" === a.action ? this.redraw("collect") : this.redraw(a.action, a.info.id), this.current = a.info.id;
                    if (a.stopSimilar) {
                        var b = function(a) {
    ...
    c.player.prototype.setMasteryByString = function(a) {
        for (var b =
            ...
            for (; --c;)
                for (; --d;)
                    if (f = 24 * b + 4 * c + d, f = parseInt(a.charAt(f), 10)) i = b + "" + c + "" + d, this.mastery[i] = f;
    ...
    c.player.prototype.updateMasteryStringFor = function(a) {
        var b = parseInt(a.charAt(0), 10) - 2,
            ...
            b = 24 * b + 4 * c + d;
        this.masteryString = this.masteryString.slice(0, b) + this.mastery[a] + this.masteryString.slice(b + 1)
    };
    ...
    f.calcAspd = function(a, b, c, d) {
        return Math.round(1E3 * 1 / (1.6 * (1 + b)) * (1 + (d || 0) + c * (a - 1) / 100)) / 1E3
    };
    ...
    c._spellDataLink.prototype.generateLinks = function() {
        var a, b, c;
        for (a = 0, b = this.spell.vars.length; a < b; ++a) c = this.spell.vars[a], this.data[c.key] = this.generateLink(c);
        for (a = 1, b = this.spell.effect.length; a < b; ++a) this.data["e" + a] = 0 === this.calc ? this.spell.effectBurn[a] : this.spell.effect[a][this.spellLevel - 1]
    };
    c._spellDataLink.prototype.generateLink = function(a) {
        if (0 === this.calc) switch (a.link) {
                case "@player.level":
                ...
                case "@stacks":
                    return "object" === typeof a.coeff ? a.coeff.join("/") + " " + f.t("perStack") : a.coeff + " " + f.t("perStack");
                default:
                    if (0 === a.link.indexOf("@dynamic.")) break;
                    return "object" === typeof a.coeff ? a.coeff.join("/") : a.coeff
            } else if (1 === this.calc) switch (a.link) {
                case "@player.level":
                    return a.coeff[0] + " - " + a.coeff[a.coeff.length - 1];
                case "@stacks":
                    return "object" === typeof a.coeff ? a.coeff[this.spellLevel - 1] + " " + f.t("perStack") : a.coeff + " " + f.t("perStack");
                case "@cooldownsummoner":
                case "@cooldownchampion":
                    return this.spell.cooldown[this.spellLevel -
                        1];
                default:
                    return "object" === typeof a.coeff ? a.coeff[this.spellLevel - 1] : a.coeff
            }
            return ""
    };
    ...
    "undefined" !== typeof l.rg_force_endapp ? l.rg_force_endapp() : (c.dynamicScan(f.$("body")[0]), c.endApp = {
        tooltip: c.buildController("item", "item_tooltip", "tooltip"),
        itemmodal: c.buildController(!1,
            "item", "item_modal", "modal")
    }, c.endApp.tooltip.addReactiveEvent("mousemove"), c.endApp.itemmodal.addReactiveEvent("click", {
        buttonRestrict: 0,
        stopSimilar: !0,
        allowModelChange: !1,
        action: "getFull",
        ...
        function a(a) {
            ...
            a: for (; b < a.ms.length; ++b) {
                ...
                f.fire.plan("model", {
                    ...
                    a.app.ms[a.index] === b.name && (a.app.ms.splice(a.index, 1), 0 === a.app.ms.length &&
                        (a.app.app(), f.fire.scrap(c)))
                })
            }
            0 === a.ms.length && a.app()
        }
